...
class ShapeApp:
    ...
    def _build_banner(self, parent):
        banner = tk.Frame(parent, bg="#000000", height=64)
        ...
        # Settings + Debug Log, top-right. Placed to the left of the hidden
        # rangoli hit-area below so it stays reachable and unobstructed.
        controls = tk.Frame(banner, bg="#000000")
        controls.place(relx=1.0, rely=0.5, anchor="e", x=-100)
        ...
        self.debug_log_btn = self._color_button(
            ...
            "#1e293b", width=118, height=36, font_size=11, corner_radius=10)
        self.debug_log_btn.pack(side="left", padx=(0, 8))

        self.settings_btn = self._color_button(
            controls, "⚙", self._open_settings_popup, "#1e293b",
            width=40, height=36, font_size=15, corner_radius=18)
    ...
    def _build_live_camera_panel(self, canvas_outer, canvas_h):
        ...
        canvas's height. Always visible; sits idle until a print starts."""
        box_h = canvas_h
        box_w = max(320, int(canvas_h * 0.9))
        self._live_cam_frame_size = (box_w - 24, box_h - 90)
        ...
        cam_header.pack(fill="x", padx=10, pady=(10, 4))
        ...
        self._color_button(
            ...
            width=100, height=28, font_size=10, corner_radius=6,
        ).pack(side="right")

        cam_pick_row = tk.Frame(cam_panel, bg=BG_CARD)
        cam_pick_row.pack(fill="x", padx=10, pady=(0, 6))
        ...
        self._live_cam_combo = ctk.CTkComboBox(
            ...
            state="readonly", width=180, height=26, font=("Segoe UI", 9),
        ...
        self._color_button(
            ...
            width=30, height=26, font_size=11, corner_radius=6,
        ).pack(side="right")

        self._live_cam_label = tk.Label(cam_panel, bg="#000000")
        self._live_cam_label.pack(fill="both", expand=True, padx=10,
                                   pady=(0, 10))
        self._live_cam_label.configure(image=self._camera_idle_image())

        cam_panel.place(relx=0.0, rely=0.5, anchor="w", x=20)
        cam_panel.lift()
    ...
    def _stop_live_camera(self):
        ...
        print finishes, and on app shutdown. The panel itself stays visible,
        just falls back to the idle placeholder."""
        self._live_cam_active = False
